...
for device in devices:
    ...
    try:
        ...
        logging.info(f"Applied {len(config_commands)} configuration commands to {device['device_name']} ({device['host']})")

        verification_output = net_connect.send_command("show run")
        outputs = {
